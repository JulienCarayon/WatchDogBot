...
const char *ssid = "Freebox-5C96C4";             // Enter your WiFi name
const char *password = "9v6tvq6b2vqnx3zhq6w2f5"; // Enter WiFi password
...
void callback(char *topic, byte *payload, unsigned int length)
{
  ...
  if (get_temperature)
  {
    Serial.println("coucou les loulouos");
    float temperature = dht11_sensor.return_temp();
    // float temperature = dht.readTemperature();
    //  publishSerialData(MQTT_SERIAL_PUBLISH_CH, temperature);
    char buffer[64];
